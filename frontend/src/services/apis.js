...
export const paymentsEndpoints = {
  GET_PURCHASE_HISTORY_API: BASE_URL + "/api/v1/payment/getPurchaseHistory",
}
...
export const courseEndpoints = {
  ...
  SEARCH_COURSE_API: BASE_URL + "/api/v1/course/search",
...
export const quizEndpoints = {
  ...
  GET_QUIZZES_FOR_COURSE_API: BASE_URL + "/api/v1/quiz/course",
  UPDATE_QUIZ_API: BASE_URL + "/api/v1/quiz",
  DELETE_QUIZ_API: BASE_URL + "/api/v1/quiz",
}
